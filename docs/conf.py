...
MOCK_MODULES = ['numpy', 'numpy.distutils.core', 'pandas', 'pysam', 'intervaltree',
                ...
                'future.utils', 'cooler', '__future__', 'logging', 'unidecode','hicmatrix','lib','HiCMatrix','hic2cool']
...
htmlhelp_basename = 'HiCExplorerdoc'
...
latex_documents = [
    (master_doc, 'HiCExplorer.tex', u'HiCExplorer Documentation',
     u'Fidel Ramírez', 'manual'),
]
...
man_pages = [
    (master_doc, 'hicexplorer', u'HiCExplorer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HiCExplorer', u'HiCExplorer Documentation',
     author, 'HiCExplorer', 'One line description of project.',
     'Miscellaneous'),
]
